...
<div x-data="rwaWizard()" x-init="init()" x-cloak>
    ...
    <!-- Top Bar Navigation (Official Platform) -->
    <div class="official-header mb-5">
        <div class="container d-flex justify-content-between align-items-center">
            <div class="d-flex flex-column">
                <span class="text-muted" style="font-size: 0.6rem; text-transform: uppercase; letter-spacing: 1px;">PLATAFORMA OFICIAL</span>
                <span class="security-badge">Inversión en Activos RWA</span>
            </div>
            <div class="d-none d-md-block">
                <ul class="list-inline m-0 x-small">
                    <li class="list-inline-item me-3"><a href="#" class="text-muted hover-gold text-decoration-none">DOCUMENTACIÓN</a></li>
                    <li class="list-inline-item me-3"><a href="#" class="text-muted hover-gold text-decoration-none">SOPORTE</a></li>
                    <li class="list-inline-item"><a href="#" class="text-muted hover-gold text-decoration-none">GUIA DE COMPRA</a></li>
                </ul>
            </div>
        </div>
    </div>
